...
s_The_Arrays_Source='../menu/s_arrays.asp';// the source of the menu definitions
s_Script_DOM_Source='../menu/s_script_dom.js';// the source of your script
s_Script_NS4_Source='../menu/s_script_ns4.js';
s_Script_OLD_Source='../menu/s_script_old.js';
