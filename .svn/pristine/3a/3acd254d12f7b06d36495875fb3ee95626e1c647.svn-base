...
{
    public partial class intranet_header_no_menu_tablet : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               {
                   lblTabletLinkStart.Text = "<a href = \"/v2/intranetx/intranet/tablet/IntranetTablet.aspx\">";
                   lblTabletLinkEnd.Text = "</a>";
               }
               else
               {
                   lblTabletLinkStart.Text = "";
                   lblTabletLinkEnd.Text = "";
               }
            }
