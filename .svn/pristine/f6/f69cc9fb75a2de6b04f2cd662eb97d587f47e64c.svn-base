<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingRoutePlaner.aspx.cs" Inherits="HTB.v2.intranetx.routeplanter.bingmaps.BingRoutePlaner" %>
    ...
    <script type="text/javascript">
        ...
        function UpdateStatus() {
            HTB.v2.intranetx.WS.WsProgress.GetBingRoutePlannerTaskStatus(
                                function (status) {
                                    if (status == null) {
                                        $get('message').innerHTML = 'Status Null: ' + _nullStatusCounter;
                                        _nullStatusCounter = _nullStatusCounter + 1;
                                    }
