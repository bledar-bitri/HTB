<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingRoutePlanerAutomaticTablet.aspx.cs" Inherits="HTB.v2.intranetx.routeplanter.bingmaps.tablet.BingRoutePlanerAutomaticTablet" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function UpdateStatus() {
            HTB.v2.intranetx.WS.WsProgress.GetBingRoutePlannerAutomaticTaskStatus(
                                function (status) {
        ...
        <tr>
            <td class="tblDataAll" align="left">
                <table border="0" align="center" cellpadding="3" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2" class="tblDataAll">
                            <asp:Label runat="server" ID="lblLastRoute"/>
                        </td>
                    </tr>
                   ...
                   <%-- <tr runat="server" id="tr1">
                        <td valign="top" class="EditCaption">
                            <div align="right">Routenname:&nbsp;</div>
                        </td>
                        <td class="EditData">
                    ...
                    <tr runat="server" id="trPLZ">
                        <td valign="top" class="EditCaption">
                            <div align="right">Uhrzeit (ss:mm) :&nbsp;</div>
                        </td>
                        <td class="EditData">
                            Erste Termin:&nbsp;
                            <asp:TextBox runat="server" ID="txtFirstAppointment" type="text" class="docText" size="15" onfocus="this.style.backgroundColor='#DFF4FF';" onblur="this.style.backgroundColor='';" Text="07:00"/>
                            <ajax:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Century="2000" TargetControlID="txtFirstAppointment" Mask="99:99" MessageValidatorTip="true" MaskType="Time" ErrorTooltipEnabled="True" />
                            <ajax:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1" ControlToValidate="txtFirstAppointment" InvalidValueMessage="Uhrzeit ist ung&uuml;ltig!" Display="Dynamic" InvalidValueBlurredMessage="* Ung&uuml;ltig! "/>
                            &nbsp;&nbsp;&nbsp;Zu Hause sein:&nbsp;
                            <asp:TextBox runat="server" ID="txtBackHome" type="text" class="docText" size="15" onfocus="this.style.backgroundColor='#DFF4FF';" onblur="this.style.backgroundColor='';" Text="15:00"/>
                            <ajax:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Century="2000" TargetControlID="txtBackHome" Mask="99:99" MessageValidatorTip="true" MaskType="Time" ErrorTooltipEnabled="True" />
                            <ajax:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlExtender="MaskedEditExtender1" ControlToValidate="txtBackHome" InvalidValueMessage="Uhrzeit ist ung&uuml;ltig!" Display="Dynamic" InvalidValueBlurredMessage="* Ung&uuml;ltig! "/>
                        </td>
                    </tr>
                    ...
                    <tr runat="server" id="trButtons">
                        <td colspan="2">
                            <br />
                            <asp:Button runat="server" ID="btnSubmit" Text="Route planen" CssClass="btnSave" Height="30" OnClick="btnSubmit_Click" />
                            <%--<asp:Button runat="server" ID="btnSubmitAnt" Text="Route planen (Ant Colony)" CssClass="btnSave" OnClick="btnSubmitAnt_Click" />--%>
                            <br/>&nbsp;<br/>
                        </td>
                    </tr>
                </table>
