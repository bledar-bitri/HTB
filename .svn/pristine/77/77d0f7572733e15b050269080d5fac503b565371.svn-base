<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingRoutePrintRouteDirectionsTablet.aspx.cs" Inherits="HTB.v2.intranetx.routeplanter.bingmaps.tablet.BingRoutePrintRouteDirectionsTablet" %>
