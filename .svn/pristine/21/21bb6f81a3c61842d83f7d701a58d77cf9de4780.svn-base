...
Class tNG_CheckDetailRecord
	...
	Public Function Execute()
		this.setFieldType tNG.getColumnType(tNG.getPrimaryKey())
		this.setFieldValue tNG.getPrimaryKeyValue()
		...
		If Not myErr is Nothing Then
			...
			myErr.Init "TRIGGER_MESSAGE__CHECK_DETAIL_RECORD", array(), array()
