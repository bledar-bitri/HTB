<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingRouteDisplayTablet.aspx.cs" Inherits="HTB.v2.intranetx.routeplanter.bingmaps.tablet.BingRouteDisplayTablet" %>
