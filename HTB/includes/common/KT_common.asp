...
' KT_common cannot overwrite this function
If isEmpty(KT_MD5Function__ALREADYLOADED) Then
...
End If
	...
	If isEmpty(KT_Common__ALREADYLOADED) Then
		KT_Common__ALREADYLOADED = True
		KT_LoadASPFiles Array("includes/common/KT_config.inc.asp", "includes/common/KT_functions.inc.asp")
	End If
%>	
