...
End If
	...
	If isEmpty(KT_WDGCore__ALREADYLOADED) Then
		KT_WDGCore__ALREADYLOADED = True
		KT_LoadASPFiles Array("includes/common/KT_common.asp", "includes/wdg/WDG_JsRecordset.class.asp", "includes/wdg/WDG_functions.inc.asp")
	End If
%>