...
Class tNG_Custom
	...
	Public Function prepareSQL()
		tNG_log__log "tNG_custom", "prepareSQL", "begin"
		parent.prepareSQL()
		sql = tNG_DynamicData(sql, Me, "SQL", null, null, null)
		this.setSQL sql
		tNG_log__log "tNG_custom", "prepareSQL", "end"
		Set prepareSQL = nothing
	End Function

	Public Function getLocalRecordset()
		tNG_log__log "tNG_custom", "getLocalRecordset", null
