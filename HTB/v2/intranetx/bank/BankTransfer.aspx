<%@ Page Language="C#" Culture="de-DE" AutoEventWireup="true" CodeBehind="BankTransfer.aspx.cs" Inherits="HTB.v2.intranetx.bank.BankTransfer" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ID" Visible="false"> 
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label id="lblInvoiceTransferID" runat="server" Text='<%# Eval("InvoiceTransferID")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField HeaderText="Name Emf&auml;nger" DataField="ClientName" SortExpression="ClientName" HtmlEncode="false"
                                                ItemStyle-HorizontalAlign="Left" />
                                            <asp:BoundField HeaderText="Kontonummer Emf&auml;nger" DataField="BankAccountNumber" SortExpression="BankAccountNumber"
