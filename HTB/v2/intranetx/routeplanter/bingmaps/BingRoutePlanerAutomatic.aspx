<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BingRoutePlanerAutomatic.aspx.cs" Inherits="HTB.v2.intranetx.routeplanter.bingmaps.BingRoutePlanerAutomatic" %>
            ...
            <td class="tblDataAll" align="left">
                <table border="0" align="center" cellpadding="3" cellspacing="0">
                    ...
                    <tr runat="server" id="trButtons">
                        <td colspan="2">
                            <br />
                            <asp:Button runat="server" ID="btnSubmit" Text="Route planen" class="btnSave" OnClick="btnSubmit_Click" />
                            <asp:Button runat="server" ID="btnSubmitAnt" Text="Route planen (Ant Colony)" class="btnSave" OnClick="btnSubmitAnt_Click" />
                            <br/>&nbsp;<br/>
                        </td>
                    </tr>
                </table>
