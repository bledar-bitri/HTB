...
{
    public partial class BingRoutePlaner : Page, ICallbackEventHandler
    {
        ...
        private String GetSqlQueryBasedOnInput()
        {
            ...
            //return "SELECT top 10 * FROM qryAktenInt";
            return sb.ToString();
        }
        ...
        private void PopulateSavedRoutes()
        {
            ...
            foreach (RouteFileRecord rec in GetSavedRouteRecords())
            {
                ...
                if (user != null)
                {
                    var sb = new StringBuilder("<a href=\"BingRouteLoader.aspx?");
...
//            txtPlzTo.Text = to;
    ...
    internal class RouteFileRecord
    {
        public int RouteUser;
