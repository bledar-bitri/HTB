<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlInstallmentOldTablet.ascx.cs" Inherits="HTB.v2.intranetx.global_files.CtlInstallmentOldTablet" %>
...
<asp:Label runat="server" Visible="false" ID="hdnAktIntId"/>
