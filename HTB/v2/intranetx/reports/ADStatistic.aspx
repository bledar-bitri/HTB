<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADStatistic.aspx.cs" Inherits="HTB.v2.intranetx.reports.ADStatistic" %>
                                ...
                                <td>
                                            ...
                                            <td class="tblFunctionBar">
                                                <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#a3cdbd">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div align="left">
                                                                <asp:DropDownList ID="ddlSB" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DdlSbSelectedIndexChanged"/>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <table border="0" align="center" cellpadding="3" cellspacing="0" class="tblDataAll">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tblDataAll">
                                                <asp:Chart ID="chrtSuccess" runat="server" Palette="BrightPastel" BackColor="WhiteSmoke" Height="320px" BorderDashStyle="Solid" BackSecondaryColor="White"
                                        ...
                                        <tr>
                                            ...
                                            <td class="tblDataAll">
                                                <asp:Chart ID="chrtUnSuccess" runat="server" Palette="BrightPastel" BackColor="WhiteSmoke" Height="430px" BorderDashStyle="Solid" BackSecondaryColor="White"
                                                    BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105"  EnableViewState="true">
