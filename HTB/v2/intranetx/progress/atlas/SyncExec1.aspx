<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SyncExec1.aspx.cs" Inherits="HTB.v2.intranetx.progress.atlas.SyncExec1" %>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
    ...
    <script type="text/C#" runat="server">
        ...
        public static DataTable GetOrdersByEmployee(int id, int year)
        {
            return GetOrdersByEmployeeInternal(id, year);
        }
    </script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function findData() {
            ...
            PageMethods.GetOrdersByEmployee(id, year, onSearchComplete);
        }
...
<head id="Head1" runat="server">
    <title>Atlas:: Sync Execution (return DataTable)</title>
</head>
<body>
