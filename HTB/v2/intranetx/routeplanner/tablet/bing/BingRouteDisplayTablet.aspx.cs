...
{
    public partial class BingRouteDisplayTablet : Page
    {
        ...
        {
            JsWaypoints = rpManager.IsOverview ? rpManager.GetJsOverviewWaypoints(RoutePlanerManager.BingMapMaxWaypoints) : rpManager.GetJsWaypoints(startIndex, RoutePlanerManager.BingMapMaxWaypoints);
        }
