...
namespace HTB.v2.intranetx.routeplanner.tablet
{
    public partial class RoutePlanerAutomaticTablet : Page, ICallbackEventHandler
    {
...
//            Session["MM_UserID"] = "99";
            ...
            {
                _taskID = Context.User.Identity.Name + ":RoutePlannerAutomatic";
