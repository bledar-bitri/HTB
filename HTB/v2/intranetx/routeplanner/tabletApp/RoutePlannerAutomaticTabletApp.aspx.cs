...
{
    public partial class RoutePlannerAutomaticTabletApp : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ValidateEntry())
            {
                _taskId = _userId + HtbConstants.RoutePlannerAutomaticTaskStatus;
...
//            FileSerializer<RoutePlannerManager>.Serialize(routeFilePath, rpManager);
        ...
        private void ReplaceAddresses(RoutePlanerManagerAutomatic rpManager)
        {
            ...
            {
                Log.Info($"Replacing {addr.ID} ==> {addr.Address}");
