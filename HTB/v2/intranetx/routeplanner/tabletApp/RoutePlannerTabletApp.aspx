<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlannerTabletApp.aspx.cs" Inherits="HTB.v2.intranetx.routeplanner.tabletApp.RoutePlannerTabletApp" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function UpdatePage(results, context) {
            StopProgress();
            document.location.href = "LeafletRouteDisplayTabletApp.aspx";
        }
        ...
        function UpdateStatus() {
            HTB.v2.intranetx.WS.WsProgress.GetBingRoutePlannerTaskStatus(
                                function (status) {
                                    if ((status == null) || (status.Progress == 100) || (status.Progress == -1)) {
