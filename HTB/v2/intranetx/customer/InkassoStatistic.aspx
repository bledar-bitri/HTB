<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InkassoStatistic.aspx.cs" Inherits="HTB.v2.intranetx.customer.InkassoStatistic" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        <td class="smallText">
                            <asp:HyperLink runat="server" NavigateUrl="Customer.aspx">Kundenportal</asp:HyperLink> | Interventionsstatistik | <asp:HyperLink runat="server" NavigateUrl="javascript:window.print()">Drucken</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <td>
                                    ...
                                    <table border="0" align="center" cellpadding="3" cellspacing="0" class="tblDataAll">
                                                ...
                                                <asp:GridView ID="gvAllCases" runat="server" AllowSorting="true" AutoGenerateColumns="False" CellPadding="2" CellSpacing="1" ShowFooter="True" BorderStyle="Inset"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAkt" FooterStyle-HorizontalAlign="Right">
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=HTBUtilities.HTBUtils.FormatPercent(1)%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Summe" SortExpression="Amount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <div class="gridData" align="right">
                                                                    <%# Eval("Amount")%></div>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>
                                                                        <%=GetTotalAmount()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAmount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <div class="gridData" align="right">
                                                                    <%# Eval("PercentAmount")%></div>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=HTBUtilities.HTBUtils.FormatPercent(1)%></strong></div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Summe" SortExpression="Amount" FooterStyle-HorizontalAlign="Right">
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>
                                                                        <%=GetTotalInProgressAmount()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAmount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=GetTotalInProgressAmountPct()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <FooterStyle BackColor="#d6f5a7" Font-Bold="True" ForeColor="White" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Summe" SortExpression="Amount" FooterStyle-HorizontalAlign="Right">
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>
                                                                        <%=GetTotalFinishedAmount()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAmount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=GetTotalFinishedAmountPct()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <FooterStyle BackColor="#d6f5a7" Font-Bold="True" ForeColor="White" />
                                        ...
                                        <tr>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Summe" SortExpression="Amount" FooterStyle-HorizontalAlign="Right">
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>
                                                                        <%=GetTotalSuccessfullAmount()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAmount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=GetTotalSuccessfullAmountPct()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <FooterStyle BackColor="#d6f5a7" Font-Bold="True" ForeColor="White" />
                                            ...
                                            <td class="tblDataAll">
                                                <asp:Chart ID="chrtSuccess" runat="server" Palette="BrightPastel" BackColor="WhiteSmoke" 
                                                    Height="150px" BorderDashStyle="Solid" BackSecondaryColor="White"
                                        ...
                                        <tr>
                                            <td valign="top" class="tblHeader" colspan="2">
                                                Status Auftr&auml;ge erfolgloss erledigt
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tblData1">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Summe" SortExpression="Amount" FooterStyle-HorizontalAlign="Right">
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>
                                                                        <%=GetTotalUnSuccessfullAmount()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Anteil" SortExpression="PercentAmount" FooterStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <div class="gridData">
                                                                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=GetTotalUnSuccessfullAmountPct()%></strong></div>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <FooterStyle BackColor="#d6f5a7" Font-Bold="True" ForeColor="White" />
                                            ...
                                            <td class="tblDataAll">
                                                <asp:Chart ID="chrtUnSuccess" runat="server" Palette="BrightPastel" BackColor="WhiteSmoke" Height="150px" BorderDashStyle="Solid" BackSecondaryColor="White"
                                                    BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105"  EnableViewState="true">
